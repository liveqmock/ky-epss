                ...
                <input id="keycode" fieldName="keycode" fieldType="text" type="hidden">
                    <table cellspacing="0" border="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="data_input"><input id="Email" class="text" type="text" eMail="true"></td>
                            <td class="lbl_right_padding"> 手&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;机 </td>
                            <td class="data_input">
                                <input id="MobilePhone" class="text" type="text" onKeyPress="onKeyPressInputInteger()"  maxLength="13">
                            </td>
                        ...
                        <tr>
                            ...
                            <td class="data_input"><input id="OtherPhone" class="text" type="text" onKeyPress="onKeyPressPhone()"></td>
                        ...
                        <tr>
                            ...
                            <td class="data_input">
                                <input id="fillint12" class="text" type="text" onKeyUp="onKeyPressInputInteger();" maxLength="12">
                            </td>
                            <td class="lbl_right_padding"><%=fillstr150%> </td>
                            <td class="data_input"><input id="fillstr150" class="text" type="text"></td>
                            <td class="lbl_right_padding"><%=fillstr600%> </td>
                            <td class="data_input"><input id="fillstr600" class="text" type="text"></td>
                        </tr>
                    </table>
            </form>
        </fieldset>
