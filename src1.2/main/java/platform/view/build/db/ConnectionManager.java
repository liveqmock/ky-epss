...
package platform.view.build.db;
...
public class ConnectionManager {
  ...
  private ConnectionManager() {
    ...
    String s = null;
    if ((s = PropertyManager.getProperty("platform.view.build.db.ConnectionManager.sDBDriver")) != null) {
      this.sDBDriver = s;
    }
    if ((s = PropertyManager.getProperty("platform.view.build.db.ConnectionManager.sConnStr")) != null) {
      this.sConnStr = s;
    }
    if ((s = PropertyManager.getProperty("platform.view.build.db.ConnectionManager.user")) != null) {
      this.user = s;
    }
    if ((s = PropertyManager.getProperty("platform.view.build.db.ConnectionManager.passwd")) != null) {
      this.passwd = s;
    }
  }
   ...
   * 得到缺省的数据库连接,以线程ID保存
   * 
   * @return zt.common.front.db.DatabaseConnection
