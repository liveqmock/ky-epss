...
<head>
	...
	<title>
		...
		<script language="javascript" src="heightDept.js"></script>

</head>
<BODY onload="onUserDocumentLoad();" onclick="body_Click()"  oncontextmenu="event.returnValue=false;">
		...
		<table style="WIDTH:100%;HEIGHT:64px;PADDING-LEFT: 0px" cellspacing="0" ID="Table1">
			<tr >
				<td colspan="2"  class="borderGrooveB">
					<font face="SimSun" style="FONT-WEIGHT: bold; FONT-SIZE: 18pt"><img class="shadowAlpha" align="absMiddle" src="<%=contextPath%>/images/domain.gif" width="48" height="48">´íÎó·ÖÀà</font>
				</td>
			</tr>
		</table>
