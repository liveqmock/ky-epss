...
public class DatabaseAgent {
    ...
    public Map getBasicOfOperator(String operatorId)
        ...
        try {
            ...
            System.err.println("Wrong, when data retrieving.   Place zt.build.security.DatabaseAgent.getBasicOfOperator(String operid).    [" + ex + "] ");
        }
        ...
        if (!rs.next()) {
            ...
            try {
                ...
                System.err.println("Wrong, when getting data from RecordSet.   Place zt.build.security.DatabaseAgent.getBasicOfOperator(String operid).    [" + ex1 + "] ");
            }
    ...
    public String getPasswordOfOperator(String operatorId)
        ...
        try {
            ...
            System.err.println("Wrong, when data retrieving.   Place zt.build.security.DatabaseAgent.getPasswordOfOperator(String operid).    [" + ex + "] ");
        }
        ...
        if (!rs.next()) {
            ...
            try {
                ...
                System.err.println("Wrong, when getting data from RecordSet.   Place zt.build.security.DatabaseAgent.getPasswordOfOperator(String operid).    [" + ex1 + "] ");
            }
    ...
    public String getOperatorIdOfOperator(String operatorId)
        ...
        try {
            ...
            System.err.println("Wrong, when data retrieving.   Place zt.build.security.DatabaseAgent.getUserIdOfOperator(String operid)    [" + ex + "] ");
        }
    ...
    public String[] getRoleIdsOfOperator(String operatorId)
        ...
        try {
            ...
            System.err.println("Wrong, when data retrieving.   Place zt.build.security.DatabaseAgent.getRoleIdsOfOperator(String operid)    [" + ex + "] ");
        }
...
//     }
    ...
    public Map getResourcesOfOperator(String operatorId)
        ...
        try {
            ...
            System.err.println("Wrong, when data retrieving.   Place zt.build.security.DatabaseAgent.getResourcesOfOperator(String operid)    [" + ex + "] ");
        }
    ...
    public List getResourceIdsOfOperator(String operatorId)
        ...
        try {
            ...
            System.err.println("Wrong, when data retrieving.   Place zt.build.security.DatabaseAgent.getResourceIdsOfOperator(String operid).    [" + ex + "] ");
        }
    ...
    public boolean isOperatorExistent(String operatorId) {
        ...
        try {
            ...
            System.err.println("Wrong, when data retrieving.   Place zt.build.security.DatabaseAgent.isOperatorExistent(String operid).    [" + ex + "] ");
        }
...
//     }
    ...
    public boolean isOperatorInRole(String operatorId, String roleId)
        ...
        try {
            ...
            System.err.println("Wrong, when data retrieving.   Place zt.build.security.DatabaseAgent.isOperatorInRole(String operid, String roleId).    [" + ex + "] ");
        }
...
//               cm.releaseConnection(dc);
            ...
            System.err.println("Wrong, when data retrieving.   Place zt.build.security.DatabaseAgent.getMenuItems(String operid, int menuItemsLevel).    [" + ex + "] ");
        }
...
//               cm.releaseConnection(dc);
            ...
            System.err.println("Wrong, when data retrieving.   Place zt.build.security.DatabaseAgent.getMenuItems(String operid, int menuItemsLevel, String parentId).    [" + ex + "] ");
        }
    ...
    public boolean checkUrl(String operatorId, String url)
        ...
        try {
            ...
            System.err.println("Wrong, when data check. Place zt.build.security.DatabaseAgent.checkUrl(String operid, String url).    [" + ex + "] ");
        }
