...
public class ImgSign {
	...
	public String writeSign(Graphics graph){
		...
		if (rad>3&&rad<9){
			graph.setFont(new java.awt.Font("", Font.ITALIC, 18));
			graph.drawString(rad+"",5,15);
		}else {
			graph.setFont(new java.awt.Font("", Font.BOLD, 15));
			graph.drawString(rad+"",5,15);
		}
		retSign +=rad;
		...
		if (rad<6){
			graph.setFont(new java.awt.Font("", Font.PLAIN, 18));
			graph.drawString(rad+"",45,15);
		}else {
			graph.setFont(new java.awt.Font("", Font.ITALIC, 15));
			graph.drawString(rad+"",45,15);
		}
		retSign +=rad;
        ...
        if (rad ==10)
        	rad = 9;
		graph.setFont(new java.awt.Font("", Font.BOLD, 18));
