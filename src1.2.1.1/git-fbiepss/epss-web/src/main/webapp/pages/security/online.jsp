...
<%
    skyline.platform.security.OperatorManager _om = (skyline.platform.security.OperatorManager)session.getAttribute(skyline.platform.form.config.SystemAttributeNames.USER_INFO_NAME);
  if ( _om == null ) {
