package epss.view.settle.settlePower;
...
@ManagedBean
@ViewScoped
public class SubcttWorkqtyProgInfoAction {
    private static final Logger logger = LoggerFactory.getLogger(SubcttWorkqtyProgInfoAction.class);
