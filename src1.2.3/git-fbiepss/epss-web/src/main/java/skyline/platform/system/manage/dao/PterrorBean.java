...
public class PterrorBean extends AbstractBasicBean implements Cloneable {
    ...
    public void setMoudleid(String moudleid) {
        sqlMaker.setField("moudleid", moudleid, Field.TEXT);
        this.moudleid = moudleid;
    }

    public void setErrortype(String errortype) {
        sqlMaker.setField("errortype", errortype, Field.TEXT);
        this.errortype = errortype;
    }

    public void setErrorindex(String errorindex) {
        sqlMaker.setField("errorindex", errorindex, Field.TEXT);
    ...
    public Object clone() throws CloneNotSupportedException {
        PterrorBean obj = (PterrorBean) super.clone();
