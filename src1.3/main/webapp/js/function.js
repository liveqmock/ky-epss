...
/************************************************************************\
*          添加Where语句:between TO_TIME(...) and TO_TIME(...)			 *
\************************************************************************/
function addNewWhereDateBetween(strfieldname,strval1,strval2){
	...
	strRev = strRev + "(";
	strRev = strRev + strfieldname;
	strRev = strRev + " between TO_TIME('"+ strval1 + "','"+sString
					+"') and TO_TIME('"+ strval2 + "','"+sString+"'))";

	return strRev;
}
/************************************************************************\
*          添加Where语句:between TO_TIME(...) and TO_TIME(...)	时间	 *
\************************************************************************/
...
function addNewWhereDateOperation(strfieldname,strval1,stroperation){
	...
	strRev = strRev + "(";
	strRev = strRev + strfieldname;
	strRev = strRev + " " + stroperation + " TO_TIME('" + strval1 +"','"+sString+"'))";
