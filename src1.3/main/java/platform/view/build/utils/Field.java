	...
	String getUpdateField()
	{
	    ...
	    else
	    {
	    	 switch(type) 
	    	 {
		         ...
		         case 4:	
		        	 	if (value != null)
		        	 		sb.append(name).append(relative).append("to_TIME('").append(value).append("','YYYY-MM-DD HH24:MI:SS')");
  ...
  String getInsertField()
  {
	    ...
	    else
	    {
	    	switch(type) 
	    	{
	        	...
	        	case 4: 	
	        		 if (value != null)
	        			 sb.append(" to_TIME('").append(value).append("','YYYY-MM-DD HH24:MI:SS')");
	        		 else
	 	        		 sb.append(" ").append(value); 	        		
	 	        	break;
	        }
       ...
       if (Basic.getDbType().equals("DB2"))
	    ...
	    else
	    {
	    	switch(type) 
	    	{
	         	...
	         	case 2: sb.append(name).append(relative).append(value); break;
	         	case 3: sb.append(name).append(relative).append("to_TIME('").append(value).append("','YYYY-MM-DD HH24:MI:SS')"); break;
	         	case 4: sb.append(name).append(relative).append("to_TIME('").append(value).append("','YYYY-MM-DD HH24:MI:SS')"); break;
	        }
	    }     
