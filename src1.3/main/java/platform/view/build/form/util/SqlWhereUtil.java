...
public class SqlWhereUtil {
    private Logger log = Logger.getLogger("zt.build.form.util.SqlWhereUtil");
     ...
     * @param fldname
     * @param value
     * @param type - 类型(0-字符 1-数字 2-日期)
     * @param operator － 操作符 (-1-无符号,0-等号1-小于2-大于3-like4－小于等于5-大于等于6不等于7-not like)
     * @param relationOpr - 关系符(and、or)
     */
...
//        swu.addWhereField("t1","id",SqlWhereUtil.Number_Type,"00001");
        ...
        swu.addWhereField("t2","date","20030405",SqlWhereUtil.DataType_TIME,SqlWhereUtil.OperatorType_Like,SqlWhereUtil.RelationOperator_And);
        swu.addWhereField("t2","date","20030406",SqlWhereUtil.DataType_TIME,SqlWhereUtil.OperatorType_Like,SqlWhereUtil.RelationOperator_And);
