    ...
    private void recursiveDataTable(String strLevelParentId,
        ...
        for(CttItem itemUnit: subCttItemList){
            ...
            if(progStlItemSubMList.size()>0){
                ...
                String strCreatedByNameTemp=cttInfoService.getUserName(progStlItemSubM.getCreatedBy());
                ...
                String strLastUpdByNameTemp=cttInfoService.getUserName(progStlItemSubM.getLastUpdBy());
