...
import epss.common.enums.EnumAutoLinkFlag;
...
import epss.service.ProgStlItemSubMService;
...
@ManagedBean
@ViewScoped
public class ProgStlInfoSubFSPAction {
    private static final Logger logger = LoggerFactory.getLogger(ProgStlInfoSubFSPAction.class);
    ...
    public void selectRecordAction2(String strSubmitTypePara) {
        try {
